...
export default function Registration() {
  ...
  usePageMeta({
    title: 'Registration — Summer Classes — Cloud Krida',
    description: 'Register for Cloud Krida Summer Classes. Coming soon.',
  })

  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-base)', color: 'var(--text-primary)', fontFamily: 'Inter, system-ui, sans-serif' }}>
      <GlobalNav />
      <Breadcrumb trail={[{ label: 'Learning Programs', path: '/summerclasses' }, { label: 'Registration' }]} />
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '180px 24px 96px' }}>
        ...
        >
          ...
          <p style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.65, marginBottom: 32 }}>
            Summer Classes registration is coming soon.
          </p>
          <div style={{
