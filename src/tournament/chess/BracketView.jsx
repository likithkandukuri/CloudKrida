    ...
    >
      ...
      >
        ...
        <button onClick={onClose} style={{
          ...
          background: '#a78bfa', border: 'none', color: '#050912', fontWeight: 700,
    ...
    for (let i = 0; i < roundMs.length; i += 2) {
      ...
      paths.push(
        <path key={`a-${r}-${i}`} d={`M ${x1},${y1a} C ${mx},${y1a} ${mx},${yp} ${x2},${yp}`}
              fill="none" stroke="rgba(167,139,250,0.22)" strokeWidth="1" />,
    ...
    <div className="chess-section-lg">
      ...
      {totalReal > 0 && (
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ height: 4, background: 'rgba(167,139,250,0.1)', borderRadius: 2, overflow: 'hidden' }}>
            <motion.div
              style={{ height: '100%', background: 'linear-gradient(90deg, #c084fc, #a78bfa)', borderRadius: 2 }}
              initial={{ width: 0 }}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24, flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(167,139,250,0.12)', borderRadius: 10, padding: 3, gap: 3 }}>
